...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "investments.InvestmentPlan": "fas fa-list-alt",
        ...
        "investments.Coupon": "fas fa-ticket-alt",
        "investments.AgentApplication": "fas fa-user-tie",
        "investments.AccountUpgrade": "fas fa-level-up-alt",
        "kyc": "fas fa-id-card",
        "kyc.KYCVerification": "fas fa-id-card-alt",
